...
export default function Footer() {
  return (
    <div className="">
      <footer className="w-screen overflow-x-hidden bg-black py-10 px-6 sm:px-6 lg:px-8">
        {/* <!-- Grid --> */}
        <div className="md:flex w-screen grid grid-cols-2 justify-around mb-10">
          ...
          <div>
            <h4 className="py-2 text-xs font-semibold text-gray-900 uppercase dark:text-gray-100">
              Product
            </h4>
