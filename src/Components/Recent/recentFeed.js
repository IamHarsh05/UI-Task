    ...
    <div className="overflow-hidden py-4">
      <div className="w-full px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="flex justify-between">
          <p className="my-4 text-lg font-semibold">Recent Added Stores</p>
        </div>
        <div className="filters mt-2 flex overflow-scroll">
          <Filter />
        </div>
        <div
          className={`feeds mx-auto mt-2 ${seeall} overflow-x-scroll max-w-2xl grid-cols-1 gap-x-8 gap-y-8 border-t border-gray-200 pt-10 sm:mt-6 sm:pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3`}
        >
